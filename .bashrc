...
export PATH="$PATH:/afs/cs.cmu.edu/academic/class/15213-f18/bin"
export PATH="$PATH:$HOME/intel/bin/"
PATH="/usr/local/depot/ispc-v1.9.1-linux/:${PATH}"; export PATH
export PATH=/usr/local/depot/cuda-8.0/bin:${PATH}
export LD_LIBRARY_PATH=/usr/local/depot/cuda-8.0/lib64/:${LD_LIBRARY_PATH}
...
export GOPATH=$HOME/private/15440/Weihang-Fans/
export PATH=/usr/local/depot/llvm-7.0/bin/:$PATH
